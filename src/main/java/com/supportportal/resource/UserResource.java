...
public class UserResource extends ExceptionHandling {
    ...
    public static final String EMAIL_SENT = "new password was sent to Email: ";
    ...
    public ResponseEntity<User> addNewUser(@RequestParam("currentUsername") String currentUsername,
                                           ...
                                           @RequestParam("isNonLocked") String isNonLocked,
                                           @RequestParam(value = "profileImage", required = false) MultipartFile profileImage) throws UserNotFoundException, UsernameExistException, EmailExistException, IOException {
        User updateUser = this.userService.updateUser(currentUsername, firstName, lastName, username, email, role, Boolean.parseBoolean(isNonLocked), Boolean.parseBoolean(isActive), profileImage);
