...
public class EmailConstant {
    ...
    public static final String USERNAME = "dinh.phu.java@gmail.com";
    public static final String PASSWORD = "qazWSX1@";
    public static final String FROM_EMAIL = "dinh.phu.java@gmail.com";
